...
*The repository navigator, preserved content-identical from the pre-launch README (ATOM-120 H2; one recorded correction: the constitution counts five normative documents, not four). For the storefront, see [README.md](../README.md).*
...
| [framework/](../framework/) | The constitution: five normative documents binding every atom |
